 ...
 */
@WebServlet(name = "UploadServlet", urlPatterns = {"/faces/photos/Upload.html", "/faces/members/Upload.html", "/faces/Upload.html","/faces/inbox/Upload.html", "/faces/sent/Upload.html", "/faces/favorites/Upload.html", "/faces/umightlike/Upload.html", "/faces/hasviewedprofiletwo/Upload.html"})
@MultipartConfig
...
public class UploadServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (p1.getSize() == 0) {
                ...
                response.sendRedirect("/proTen/faces/ListNoPhoto.xhtml");
            } else {
 ...
 String Id = UUID.randomUUID().toString();
         ...
         //       }
                ...
                String destination = "/proTen/faces/JCrop.jsp";
