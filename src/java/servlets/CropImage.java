 ...
 //this below was tested and worked.
    public void persistPhoto() {
        try {
            ...
            //  String sssend = " UPDATE Photos o " + " SET o.imageurl1a"   + _namec + "'" + " WHERE o.photouserid ='" + "23" + "'";
            String sssend = " UPDATE Photos o " + " SET o.imageurl" + 1 + "a" + " = '" + _named + "'" + " WHERE o.photouserid ='" + llop + "'";


            String sssendtwo = " UPDATE Photos o " + " SET o.imageurl" + 1 + "b" + " = '" + _namedtwo + "'" + " WHERE o.photouserid ='" + llop + "'";


            String sssendthree = " UPDATE Photos o " + " SET o.imageurl" + 2 + "a" + " = '" + "*" + "'" + " WHERE o.photouserid ='" + llop + "'";


            String sssendfour = " UPDATE Photos o " + " SET o.imageurl" + 2 + "b" + " = '" + "*" + "'" + " WHERE o.photouserid ='" + llop + "'";
            ...
            Query qqqq = em.createQuery(sssendfour);
    ...
    public void persistPhotoIsempty() {
        try {
            ...
            String sssendfive = " UPDATE Photos o " + " SET o.imageurl" + 2 + "a" + " = '" + "*" + "'" + " WHERE o.photouserid ='" + llop + "'";

            String sssendsix = " UPDATE Photos o " + " SET o.imageurl" + 2 + "b" + " = '" + "*" + "'" + " WHERE o.photouserid ='" + llop + "'";
            ...
            Query qqqq = em.createQuery(sssendfive);

            Query qqqqq = em.createQuery(sssendsix);
