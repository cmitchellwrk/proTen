...
--
-- Table structure for table `dateideas`
--
...
CREATE TABLE `dateideas` (
  ...
  `idea` text,
  `ideacatagory` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dateideas`
--

LOCK TABLES `dateideas` WRITE;
/*!40000 ALTER TABLE `dateideas` DISABLE KEYS */;
/*!40000 ALTER TABLE `dateideas` ENABLE KEYS */;
UNLOCK TABLES;
