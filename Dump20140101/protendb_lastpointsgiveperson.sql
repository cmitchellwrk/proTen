...
--
-- Table structure for table `lastpointsgiveperson`
--

DROP TABLE IF EXISTS `lastpointsgiveperson`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lastpointsgiveperson` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `idpersonpointsgive` bigint(20) NOT NULL,
  ...
  `datelastptsgiven` varchar(30) NOT NULL,
  `badge` varchar(50) DEFAULT NULL,
  `badgeimageurl` varchar(70) DEFAULT NULL,
  `totalpointsgivensofar` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `lastpointsgiveperson`
--

LOCK TABLES `lastpointsgiveperson` WRITE;
/*!40000 ALTER TABLE `lastpointsgiveperson` DISABLE KEYS */;
/*!40000 ALTER TABLE `lastpointsgiveperson` ENABLE KEYS */;
UNLOCK TABLES;
